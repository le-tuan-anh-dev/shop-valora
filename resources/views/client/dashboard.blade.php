          ...
          <div class="profile-box"> 
            ...
            <div class="profile-contain">
              ...
              <div class="profile-name"> 
                <h4>{{ $user->name }}</h4>
                <h6>{{ $user->email }}</h6>
                <span data-bs-toggle="modal" data-bs-target="#edit-profile-modal" title="Chỉnh sửa" tabindex="0">
                    Edit Profile
                </span>
              </div>
            </div>
            ...
            <div class="dashboard-right-box">
              <div class="my-dashboard-tab">
                ...
                <div class="dashboard-user-name"> 
                  ...
                  <p>Từ trang Dashboard, bạn có thể xem nhanh lịch sử đơn hàng, cập nhật thông tin cá nhân và quản lý địa chỉ giao hàng.</p>
                ...
                <div class="total-box"> 
                  <div class="row gy-4"> 
                    <div class="col-xl-4"> 
                      <div class="totle-contain">
                        <div class="wallet-point">
                          <img src="{{ asset('client/assets/images/svg-icon/wallet.svg') }}" alt="">
                          <img class="img-1" src="{{ asset('client/assets/images/svg-icon/wallet.svg') }}" alt="">
                        </div>
                    ...
                    <div class="col-xl-4"> 
                      <div class="totle-contain">
                        <div class="wallet-point">
                          <img src="{{ asset('client/assets/images/svg-icon/coin.svg') }}" alt="">
                          <img class="img-1" src="{{ asset('client/assets/images/svg-icon/coin.svg') }}" alt="">
                        </div>
                        <div class="totle-detail"> 
                          <h6>Total Orders</h6>
                          <h4>{{ $totalOrders }}</h4>
                    ...
                    <div class="col-xl-4"> 
                      <div class="totle-contain">
                        <div class="wallet-point">
                          <img src="{{ asset('client/assets/images/svg-icon/order.svg') }}" alt="">
                          <img class="img-1" src="{{ asset('client/assets/images/svg-icon/order.svg') }}" alt="">
                        </div>
                        <div class="totle-detail"> 
                          <h6>Balance</h6>
                            ...
                            <div class="product-box">
                              @php
                                  $firstItemImage = $firstItem->product_image
                                      ? asset('storage/' . ltrim($firstItem->product_image, '/'))
                                      : asset('client/assets/images/notification/1.jpg');
                              @endphp
                              ...
                              <span class="address">
                                <span class="address-home">
                                  ...
                                  <textarea name="address" class="form-control form-control-sm" rows="2"
                                            placeholder="Địa chỉ chi tiết">{{ old('address', $address->address) }}</textarea>
                                </span>
                              </span>
                ...
                <form action="{{ route('checkout.store-address') }}" method="POST" class="row g-2">
                  ...
                  <div class="col-12">
                    ...
                    <textarea name="address" class="form-control" rows="3"
                              placeholder="Địa chỉ chi tiết" required>{{ old('address') }}</textarea>
                  </div>
...
<div class="modal fade" id="edit-profile-modal" tabindex="-1"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <form action="{{ route('client.dashboard.update-profile') }}"
