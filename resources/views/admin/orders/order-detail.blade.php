                              ...
                              <div class="row">
                                   <div class="col-lg-12">
                                        <div class="card">
                                                       ...
                                                       <div>
                                                            @php
                                                                $paymentStatusColors = [
                                                                    ...
                                                                    'paid' => ['bg' => 'bg-success-subtle', 'text' => 'text-success', 'label' => 'Đã thanh toán'],
                                                                    'failed' => ['bg' => 'bg-danger-subtle', 'text' => 'text-danger', 'label' => 'Thanh toán thất bại']
                                                                ];
                                                            ...
                                                            <h4 class="fw-medium text-dark d-flex align-items-center gap-2">
                                                                ...
                                                                <span class="border {{ $status['border'] }} {{ $status['text'] }} fs-13 px-2 py-1 rounded">{{ $status['label'] }}</span>
                                                            </h4>
                                                            <p class="mb-0">Đơn hàng / Chi tiết đơn hàng / #{{ $order->order_number }} - {{ $order->created_at->format('d/m/Y \lú\c H:i') }}</p>
                                                       </div>
                                                       <div>
                                             ...
                                             @if(in_array($order->status, ['confirmed', 'awaiting_pickup']))
                                             <div class="card-footer d-flex flex-wrap align-items-center justify-content-between bg-light-subtle gap-2">
                                                  ...
                                                  <p class="border rounded mb-0 px-2 py-1 bg-body">
                                                       <iconify-icon icon="solar:calendar-bold-duotone" class="align-middle fs-16"></iconify-icon>
                                                       Ngày xác nhận: <span class="text-dark fw-medium">{{ $order->confirmed_at->format('d/m/Y H:i') }}</span>
                                                  </p>
                                                  @endif
                                                  <div>
                                                       ...
                                                       <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST" class="d-inline">
                                                            ...
                                                            @method('PUT')
                                                            <input type="hidden" name="status" value="awaiting_pickup">
                                                            <button type="submit" class="btn btn-primary">Chuyển sang chờ lấy hàng</button>
                                                       </form>
                                                       @elseif($order->status == 'awaiting_pickup')
                                                       <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            @method('PUT')
                                                            <input type="hidden" name="status" value="shipping">
                                                                           ...
                                                                           <div class="d-flex align-items-center gap-2">
                                                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                                                     @if($item->product_image)
                                                                                          <img src="{{ asset('storage/' . $item->product_image) }}" alt="" class="avatar-md" style="object-fit: cover;">
                                                                                     @else
                                                                                          <iconify-icon icon="solar:image-broken" class="fs-24 text-muted"></iconify-icon>
                                                                                     @endif
                                                                                </div>
                                                                                <div>
                                                                                     ...
                                                                                     @if($item->variant_name)
                                                                                          <p class="text-muted mb-0 mt-1 fs-13">
                                                                                               <span>Biến thể: </span>{{ $item->variant_name }}
                                                                                          </p>
                                                                                     @endif
                                                  ...
                                                  <div class="position-relative ms-2">
                                                       ...
                                                       <div class="position-relative ps-4">
                                                            <div class="mb-4">
                                                                 ...
                                                                 <div class="ms-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                                      <div>
                                                                           <h5 class="mb-1 text-dark fw-medium fs-15">Đơn hàng đã được tạo</h5>
                                                                           <p class="mb-0">Đơn hàng #{{ $order->order_number }} được tạo bởi {{ $order->customer_name }}</p>
                                                                      </div>
                                                       ...
                                                       <div class="position-relative ps-4">
                                                            <div class="mb-4">
                                                                 ...
                                                                 <div class="ms-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                                      <div>
                                                                           <h5 class="mb-1 text-dark fw-medium fs-15">Đơn hàng đã được xác nhận</h5>
                                                                           <p class="mb-0">Đơn hàng đã được xác nhận và đang được xử lý</p>
                                                                      </div>
                                                                      <p class="mb-0">{{ $order->confirmed_at->format('d/m/Y, H:i') }}</p>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       @endif
                                                       ...
                                                       <div class="position-relative ps-4">
                                                            <div class="mb-4">
                                                                 ...
                                                                 <div class="ms-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                                      <div>
                                                                           <h5 class="mb-1 text-dark fw-medium fs-15">Thanh toán thành công</h5>
                                                       ...
                                                       <div class="position-relative ps-4">
                                                            <div class="mb-4">
                                                                 ...
                                                                 <div class="ms-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                                      <div>
                                                                           <h5 class="mb-1 text-dark fw-medium fs-15">Đơn hàng đã hoàn thành</h5>
                                                                           <p class="mb-0">Đơn hàng đã được giao thành công</p>
                                                                      </div>
                                                                      <p class="mb-0">{{ $order->completed_at->format('d/m/Y, H:i') }}</p>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       @endif
                                                       ...
                                                       <div class="position-relative ps-4">
                                                            <div class="mb-2">
                                                                 <span class="position-absolute start-0 avatar-sm translate-middle-x bg-light d-inline-flex align-items-center justify-content-center rounded-circle text-danger fs-20">
                                                                      <iconify-icon icon="solar:close-circle-bold-duotone"></iconify-icon>
                                                                 </span>
                                                                 <div class="ms-2 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                                      <div>
                                                                           <h5 class="mb-2 text-dark fw-medium fs-15">Đơn hàng đã bị hủy</h5>
                                                                           @if($order->admin_note)
                                                                                <p class="mb-0 text-muted">Lý do: {{ $order->admin_note }}</p>
                                                                           @endif
                                                                      </div>
                                                                      <p class="mb-0">{{ $order->cancelled_at->format('d/m/Y, H:i') }}</p>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       @endif
                                                  ...
                                                  <div class="row g-3 g-lg-0">
                                                       ...
                                                       <div class="col-lg-3 border-end">
                                                            <div class="d-flex align-items-center gap-3 justify-content-between px-3">
                                                                 ...
                                                                 <div class="avatar bg-light d-flex align-items-center justify-content-center rounded">
                                                                      <iconify-icon icon="solar:wallet-money-bold-duotone" class="fs-35 text-primary"></iconify-icon>
                                                                 </div>
                                                            </div>
                                                       </div>
                                                       <div class="col-lg-3">
                         ...
                         <div class="col-xl-3 col-lg-4">
                              <div class="card">
                                             ...
                                             <table class="table mb-0">
                                                  <tbody>
                                                       <tr>
                                                            ...
                                                            <td class="text-end text-dark fw-medium px-0">{{ number_format($order->subtotal, 0, ',', '.') }}₫</td>
                                                       </tr>
                                                       <tr>
                                                            <td class="px-0">
                                                                 <p class="d-flex mb-0 align-items-center gap-1">
                                                            ...
                                                            <td class="text-end text-dark fw-medium px-0">-{{ number_format($order->promotion_amount, 0, ',', '.') }}₫</td>
                                                       </tr>
                                                       <tr>
                                                            <td class="px-0">
                                                                 <p class="d-flex mb-0 align-items-center gap-1">
                                                            ...
                                                            <td class="text-end text-dark fw-medium px-0">{{ number_format($order->shipping_fee, 0, ',', '.') }}₫</td>
                                                       </tr>
                                                  </tbody>
                                             </table>
                                        </div>
                                   ...
                                   <div class="card-footer d-flex align-items-center justify-content-between bg-light-subtle">
                                        ...
                                        <div>
                                             <p class="fw-medium text-dark mb-0">{{ number_format($order->total_amount, 0, ',', '.') }}₫</p>
                                        </div>
                                   </div>
                              </div>
                              <div class="card">
                                   ...
                                   <div class="card-body">
                                        <div class="d-flex align-items-center gap-3 mb-3">
                                             <div class="rounded-3 bg-light avatar d-flex align-items-center justify-content-center">
                                                  <iconify-icon icon="solar:wallet-money-bold-duotone" class="fs-32 text-primary"></iconify-icon>
                                             </div>
                                             <div>
                                        ...
                                        <p class="text-dark mb-1 fw-medium">
                                             Mã giao dịch: 
                                             <span class="text-muted fw-normal fs-13">{{ $order->payment_details['transaction_id'] }}</span>
                                        </p>
                                        @endif
                                        @if($order->payment_reference)
                              ...
                              <div class="card">
                                   ...
                                   <div class="card-body">
                                        <div class="d-flex align-items-center gap-2">
                                             <div class="avatar rounded-3 border border-light border-3 bg-light d-flex align-items-center justify-content-center">
                                                  <iconify-icon icon="solar:user-circle-bold-duotone" class="fs-32 text-primary"></iconify-icon>
                                             </div>
                                             <div>
