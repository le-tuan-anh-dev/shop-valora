                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ number_format($stats['unpaid_orders']) }}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">
                                        {{ number_format($stats['cancelled_orders']) }}</p>
                                </div>
                                <div>
                                    <div class="avatar-md bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ number_format($stats['pending_orders']) }}
                                    </p>
                                </div>
                                <div>
                                    <div class="avatar-md bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">
                                        {{ number_format($stats['confirmed_orders']) }}</p>
                                </div>
                                <div>
                                    <div class="avatar-md bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">
                                        {{ number_format($stats['shipping_orders']) }}</p>
                                </div>
                                <div>
                                    <div class="avatar-md bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">{{ number_format($stats['total_orders']) }}
                                    </p>
                                </div>
                                <div>
                                    <div class="avatar-md bg-primary bg-opacity-10 rounded">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted fw-medium fs-22 mb-0">
                                        {{ number_format($stats['completed_orders']) }}</p>
                                </div>
                                <div>
                                    <div class="avatar-md bg-primary bg-opacity-10 rounded">
                                ...
                                <form method="GET" action="{{ route('admin.orders.list') }}" class="d-flex gap-2">
                                    ...
                                    <select name="status" class="form-select form-select-sm" style="width: 150px;">
                                        ...
                                        <option value="awaiting_pickup"
                                            {{ request('status') == 'awaiting_pickup' ? 'selected' : '' }}>Chờ lấy hàng
                                        </option>
                                        <option value="shipping" {{ request('status') == 'shipping' ? 'selected' : '' }}>
                                            Đang giao</option>
                                        <option value="delivered"
                                            {{ request('status') == 'delivered' ? 'selected' : '' }}>Đã giao hàng</option>
                                        <option value="completed"
                                            {{ request('status') == 'completed' ? 'selected' : '' }}>Đã hoàn thành</option>
                                        <option value="cancelled_by_customer"
                                            {{ request('status') == 'cancelled_by_customer' ? 'selected' : '' }}>Khách hủy
                                        </option>
                                        <option value="cancelled_by_admin"
                                            {{ request('status') == 'cancelled_by_admin' ? 'selected' : '' }}>Admin hủy
                                        </option>
                                        <option value="delivery_failed"
                                            {{ request('status') == 'delivery_failed' ? 'selected' : '' }}>Giao thất bại
                                        </option>
                                    </select>
                                        ...
                                        @forelse($orders as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="badge border {{ $status['border'] }} {{ $status['text'] }} px-2 py-1 fs-13">{{ $status['label'] }}</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <div class="dropdown">
                                                            <button class="btn btn-soft-primary btn-sm dropdown-toggle"
                                                                ...
                                                                data-bs-title="Cập nhật trạng thái">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                @if (empty($allowedStatuses) && !$isCancelled)
                                                                    <li class="dropdown-item-text text-muted small">Không
                                                                        có trạng thái nào có thể chuyển</li>
                                                                @endif
                                                            </ul>
                                                        </div>
                                                    </div>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="8" class="text-center py-5">
                                                    <div class="mb-3">
                                                        <iconify-icon icon="solar:inbox-bold-duotone"
