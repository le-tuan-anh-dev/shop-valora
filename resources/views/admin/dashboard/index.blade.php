                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="GET" action="{{ route('admin.dashboard') }}" id="filterForm"
                                ...
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold">Lọc theo thời gian</label>
                                    <select name="filter" id="filterSelect" class="form-select">
                                        <option value="all" {{ ($filter ?? 'this_month') == 'all' ? 'selected' : '' }}>
                                            Tất cả</option>
                                        <option value="today" {{ ($filter ?? '') == 'today' ? 'selected' : '' }}>Hôm nay
                                        </option>
                                        <option value="yesterday" {{ ($filter ?? '') == 'yesterday' ? 'selected' : '' }}>Hôm
                                            qua</option>
                                        <option value="this_week" {{ ($filter ?? '') == 'this_week' ? 'selected' : '' }}>
                                            Tuần này</option>
                                        <option value="last_week" {{ ($filter ?? '') == 'last_week' ? 'selected' : '' }}>
                                            Tuần trước</option>
                                        <option value="this_month"
                                            {{ ($filter ?? 'this_month') == 'this_month' ? 'selected' : '' }}>Tháng này
                                        </option>
                                        <option value="last_month" {{ ($filter ?? '') == 'last_month' ? 'selected' : '' }}>
                                            Tháng trước</option>
                                        <option value="custom" {{ ($filter ?? '') == 'custom' ? 'selected' : '' }}>Tùy chỉnh
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-sm rounded-circle bg-soft-primary text-primary d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-sm rounded-circle bg-soft-info text-info d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-sm rounded-circle bg-soft-success text-success d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-sm rounded-circle bg-soft-warning text-warning d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-sm rounded-circle bg-soft-danger text-danger d-flex align-items-center justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <div
                                        class="avatar-sm rounded-circle bg-soft-secondary text-secondary d-flex align-items-center justify-content-center">
                                                    ...
                                                    @else
                                                        <div class="bg-light rounded d-flex align-items-center justify-content-center"
                                                            ...
                                                            <iconify-icon icon="solar:image-broken"
                                                                class="text-muted fs-20"></iconify-icon>
                                                        </div>
                                                    @endif
                                                </td>
                                                <td>
                                        ...
                                        @forelse($recent_orders as $order)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @endphp
                                                    <span
                                                        class="badge bg-light-{{ $color }} text-{{ $color }}">
                                                        {{ $label }}
                                                    </span>
                                                </td>
                                            </tr>
                ...
                if (filterSelect) {
                    filterSelect.addEventListener('change', function() {
                        if (this.value === 'custom') {
                            ...
                            // Tự động submit khi chọn filter nhanh (trừ custom)
                            // filterForm.submit();
                        }
                    });
                }
