                    ...
                    >
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          <p class="mb-0">
                            <span class="fw-medium">Josephine Thompson </span
                    ...
                    <div class="ms-2">
                      ...
                      <div class="row g-2 mt-2">
                        <div class="col-lg-4">
                          <a href="#!">
                            <img
                              src="{{ asset('admin/assets/images/small/img-6.jpg')}}"
                              alt=""
                        ...
                        <div class="col-lg-4">
                          <a href="#!">
                            <img
                              src="{{ asset('admin/assets/images/small/img-3.jpg')}}"
                              alt=""
                              class="img-fluid rounded"
                            />
                          </a>
                        ...
                        <div class="col-lg-4">
                          <a href="#!">
                            <img
                              src="{{ asset('admin/assets/images/small/img-4.jpg')}}"
                              alt=""
                              class="img-fluid rounded"
                            />
                          </a>
      ...
      <div class="main-nav">
        ...
        <div class="logo-box">
          <a href="index.html" class="logo-dark">
            <img
              src="{{ asset('admin/assets/images/logo-sm.png')}}"
              class="logo-sm"
              alt="logo sm"
            />
            <img
          ...
          <a href="index.html" class="logo-light">
            ...
            />
            <img
              src="{{ asset('admin/assets/images/logo-light.png')}}"
              class="logo-lg"
              alt="logo light"
            />
          </a>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebarInvoice">
                <ul class="nav sub-navbar-nav">
                  ...
                  <li class="sub-nav-item">
                    <a class="sub-nav-link" href="invoice-details.html"
                      >Details</a
                    >
                  </li>
                  <li class="sub-nav-item">
